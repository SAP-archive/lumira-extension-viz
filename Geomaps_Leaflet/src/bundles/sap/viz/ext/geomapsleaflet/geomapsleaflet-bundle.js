define("geomapsleaflet-bundle", ["sap_viz_ext_geomapsleaflet-src/js/flow", "css!sap_viz_ext_geomapsleaflet-src/style/default.css"],
			...
			"components": [{
				...
				"customProperties": {
					...
					"resources": [{
						...
						"path": "./sap_viz_ext_geomapsleaflet-src/resources/templates"
					}]
				}
			}]
		});
