define("footballheatmap-bundle", ["sap_viz_ext_footballheatmap-src/js/flow", "css!sap_viz_ext_footballheatmap-src/style/default.css"], function(flowDefinition,cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "customProperties" : {
                ...
                "description" : "",
                "icon" : {"path" : "./football.png"},
                "category" : [],
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./sap_viz_ext_footballheatmap-src/resources/templates"}]
            }
        }]
   });
