define("lossincidentoptimization-bundle", ["sap_viz_ext_lossincidentoptimization-src/js/flow",
	"css!sap_viz_ext_lossincidentoptimization-src/style/default.css"
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_lossincidentoptimization-src/resources/templates"
				}]
			}
		}]
	});
