define("timelinelegend-bundle", ["sap_viz_ext_timelinelegend-src/js/flow", "css!sap_viz_ext_timelinelegend-src/style/default.css"], function(
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_timelinelegend-src/resources/templates"
				}]
			}
		}]
	});
