define("sortablestackedbars-bundle", ["sap_viz_ext_sortablestackedbars-src/js/flow", "css!sap_viz_ext_sortablestackedbars-src/style/default.css"], function(
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_sortablestackedbars-src/resources/templates"
				}]
			}
		}]
	});
