define("lossofsales-bundle", ["sap_viz_ext_lossofsales-src/js/flow", "css!sap_viz_ext_lossofsales-src/style/default.css"], function(
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_lossofsales-src/resources/templates"
				}]
			}
		}]
	});
