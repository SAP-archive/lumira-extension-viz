define("sap_viz_ext_minidonutchart-src/js/module", ["sap_viz_ext_minidonutchart-src/js/render", "sap_viz_ext_minidonutchart-src/js/dataMapping"], function(render, processData) {
