define("sap_viz_ext_miniareachart-src/js/module", ["sap_viz_ext_miniareachart-src/js/render", "sap_viz_ext_miniareachart-src/js/dataMapping"], function(render, processData) {
