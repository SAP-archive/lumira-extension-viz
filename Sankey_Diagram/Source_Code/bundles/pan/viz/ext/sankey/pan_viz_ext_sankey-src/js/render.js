define("pan_viz_ext_sankey-src/js/render", [], function(){
    /*
    ...
    var render = function(data, container) {
        //Clean up previous HTML elements
		...
		window.pan_viz_ext_sankey_sankeyRenderer = function() {
		...
		require(["https://www.google.com/jsapi"], function() {
						google.load('visualization', '1.1', {
							packages: ['sankey'],
							callback: pan_viz_ext_sankey_sankeyRenderer
						});
					});
    };
