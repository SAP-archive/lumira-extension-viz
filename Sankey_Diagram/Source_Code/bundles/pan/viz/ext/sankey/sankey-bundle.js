define("sankey-bundle", ["pan_viz_ext_sankey-src/js/flow", "css!pan_viz_ext_sankey-src/style/default.css"], function(flowDefinition, cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "customProperties" : {
                ...
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./pan_viz_ext_sankey-src/resources/templates"}]
            }
        }]
   });
