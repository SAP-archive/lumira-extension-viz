define("footballheatmap-bundle", ["sap_viz_ext_footballheatmap-src/js/flow", "css!sap_viz_ext_footballheatmap-src/style/default.css"],
			...
			"components": [{
				...
				"customProperties": {
					...
					"resources": [{
						...
						"path": "./sap_viz_ext_footballheatmap-src/resources/templates"
					}]
				}
			}]
		});
