define("holtwinters-bundle", ["sap_viz_ext_holtwinters-src/js/flow", "css!sap_viz_ext_holtwinters-src/style/default.css"], function(
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_holtwinters-src/resources/templates"
				}]
			}
		}]
	});
