define("populationpyramid-bundle", ["sap_viz_ext_populationpyramid-src/js/flow", "css!sap_viz_ext_populationpyramid-src/style/default.css"],
			...
			"components": [{
				...
				"customProperties": {
					...
					"resources": [{
						...
						"path": "./sap_viz_ext_populationpyramid-src/resources/templates"
					}]
				}
			}]
		});
