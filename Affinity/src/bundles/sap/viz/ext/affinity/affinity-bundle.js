define("affinity-bundle", ["sap_viz_ext_affinity-src/js/flow", "css!sap_viz_ext_affinity-src/style/default.css"], function(flowDefinition,
	cssStyleDeclaration) {
	var cssString = "",
		rules, i;
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_affinity-src/resources/templates"
				}]
			}
		}]
	});
