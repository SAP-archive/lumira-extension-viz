define("electionparty-bundle", ["sap_viz_ext_electionparty-src/js/flow", "css!sap_viz_ext_electionparty-src/style/default.css"],
			...
			"components": [{
				...
				"customProperties": {
					...
					"resources": [{
						...
						"path": "./sap_viz_ext_electionparty-src/resources/templates"
					}]
				}
			}]
		});
