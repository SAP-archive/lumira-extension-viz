define("sap_viz_ext_electionparty-src/js/dataMapping", ["sap_viz_ext_electionparty-src/js/utils/util"], function(util) {
	var processData = function(data, feeds, done) {
		 ...
		 */
		var mapper = function(d, meta) {
			//replace timestamp by a date object
			d[meta.dimensions(0, 0)] = new Date(d[meta.dimensions(0, 0)]);
			return d;
		};
