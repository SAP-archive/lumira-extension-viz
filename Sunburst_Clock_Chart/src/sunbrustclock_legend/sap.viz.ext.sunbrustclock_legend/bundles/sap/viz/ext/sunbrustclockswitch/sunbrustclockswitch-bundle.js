define("sunbrustclockswitch-bundle", ["sap_viz_ext_sunbrustclockswitch-src/js/flow",
	"css!sap_viz_ext_sunbrustclockswitch-src/style/default.css"
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_sunbrustclockswitch-src/resources/templates"
				}]
			}
		}]
	});
