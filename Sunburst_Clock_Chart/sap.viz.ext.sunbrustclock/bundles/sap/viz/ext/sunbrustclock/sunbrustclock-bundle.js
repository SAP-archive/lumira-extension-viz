define("sunbrustclock-bundle", ["sap_viz_ext_sunbrustclock-src/js/flow", "css!sap_viz_ext_sunbrustclock-src/style/default.css"], function(
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_sunbrustclock-src/resources/templates"
				}]
			}
		}]
	});
