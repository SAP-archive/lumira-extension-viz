define("sap_viz_ext_exoplanets-src/js/module", ["sap_viz_ext_exoplanets-src/js/render", "sap_viz_ext_exoplanets-src/js/dataMapping"], function(render, processData) {
