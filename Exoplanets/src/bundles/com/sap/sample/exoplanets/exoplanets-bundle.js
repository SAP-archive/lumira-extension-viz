define("exoplanets-bundle", ["com_sap_sample_exoplanets-src/js/flow", "css!com_sap_sample_exoplanets-src/style/default.css"], function(flowDefinition,cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "customProperties" : {
                ...
                "icon" : {"path" : ""},
                "category" : [],
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./com_sap_sample_exoplanets-src/resources/templates"}]
            }
        }]
   });
