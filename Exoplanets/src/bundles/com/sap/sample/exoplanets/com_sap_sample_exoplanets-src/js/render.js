/*<<dependency*/
define("com_sap_sample_exoplanets-src/js/render", ["com_sap_sample_exoplanets-src/js/utils/util"], function(util){
/*dependency>>*/ 
    /**
...
// MDL: Get the radius from the data column: radiusCol.
 //   .value(function(d) { return d.radius * d.radius; })
    .value(function(d) { return d[radiusCol] * d[radiusCol]; })
// MDL: end
    .padding(5);
...
//        : 0;
    return isFinite(a[distanceCol]) || isFinite(b[distanceCol])
        ? a[distanceCol] - b[distanceCol]
        : 0;
// MDL: end
  });
...
//    color.domain(d3.extent(exoplanets, function(d) { return d.radius; }));
    color.domain(d3.extent(data, function(d) { return d[radiusCol]; }));
// MDL: end
...
//      .style("fill", function(d) { return color(d.radius); })
      .style("fill", function(d) { return color(d[radiusCol]); })
// MDL: end
    .append("title")
      .text(function(d) {
