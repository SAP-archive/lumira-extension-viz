define("interactivebullet-bundle", ["sap_viz_ext_interactivebullet-src/js/flow", "css!sap_viz_ext_interactivebullet-src/style/default.css"],
			...
			"components": [{
				...
				"customProperties": {
					...
					"resources": [{
						...
						"path": "./sap_viz_ext_interactivebullet-src/resources/templates"
					}]
				}
			}]
		});
