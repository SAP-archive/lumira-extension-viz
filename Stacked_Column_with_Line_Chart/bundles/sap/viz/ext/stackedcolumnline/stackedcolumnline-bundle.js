define("stackedcolumnline-bundle", ["sap_viz_ext_stackedcolumnline-src/js/flow", "css!sap_viz_ext_stackedcolumnline-src/style/default.css"], function(flowDefinition,cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "customProperties" : {
                ...
                "icon" : {"path" : ""},
                "category" : [],
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./sap_viz_ext_stackedcolumnline-src/resources/templates"}]
            }
        }]
   });
