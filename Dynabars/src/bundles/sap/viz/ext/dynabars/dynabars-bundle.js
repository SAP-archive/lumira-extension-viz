define("dynabars-bundle", ["sap_viz_ext_dynabars-src/js/flow", "css!sap_viz_ext_dynabars-src/style/default.css"], function(flowDefinition,
	cssStyleDeclaration) {
	var cssString = "",
		rules, i;
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_dynabars-src/resources/templates"
				}]
			}
		}]
	});
