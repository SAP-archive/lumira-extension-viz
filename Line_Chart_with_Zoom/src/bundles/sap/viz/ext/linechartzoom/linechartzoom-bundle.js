define("linechartzoom-bundle", ["sap_viz_ext_linechartzoom-src/js/flow", "css!sap_viz_ext_linechartzoom-src/style/default.css"], function(
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_linechartzoom-src/resources/templates"
				}]
			}
		}]
	});
