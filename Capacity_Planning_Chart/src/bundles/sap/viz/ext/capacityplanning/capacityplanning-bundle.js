define("capacityplanning-bundle", ["sap_viz_ext_capacityplanning-src/js/flow", "css!sap_viz_ext_capacityplanning-src/style/default.css"],
			...
			"components": [{
				...
				"customProperties": {
					...
					"resources": [{
						...
						"path": "./sap_viz_ext_capacityplanning-src/resources/templates"
					}]
				}
			}]
		});
