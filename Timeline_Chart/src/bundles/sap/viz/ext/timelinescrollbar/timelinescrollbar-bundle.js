define("timelinescrollbar-bundle", ["sap_viz_ext_timelinescrollbar-src/js/flow", "css!sap_viz_ext_timelinescrollbar-src/style/default.css"],
			...
			"components": [{
				...
				"customProperties": {
					...
					"resources": [{
						...
						"path": "./sap_viz_ext_timelinescrollbar-src/resources/templates"
					}]
				}
			}]
		});
