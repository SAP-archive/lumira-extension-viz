define("mapofjapan-bundle", ["robertrussellrjr_viz_ext_mapofjapan-src/js/flow", "css!robertrussellrjr_viz_ext_mapofjapan-src/style/default.css"], function(flowDefinition, cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "customProperties" : {
                ...
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./robertrussellrjr_viz_ext_mapofjapan-src/resources/templates"}]
            }
        }]
   });
