define("robertrussellrjr_viz_ext_mapofjapan-src/js/module", ["robertrussellrjr_viz_ext_mapofjapan-src/js/render", "robertrussellrjr_viz_ext_mapofjapan-src/js/dataMapping"], function(render, processData) {
