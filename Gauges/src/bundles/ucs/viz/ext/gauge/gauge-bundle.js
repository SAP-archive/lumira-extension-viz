define("gauge-bundle", ["ucs_viz_ext_gauge-src/js/flow", "css!ucs_viz_ext_gauge-src/style/default.css"], function(flowDefinition,
	cssStyleDeclaration) {
	var cssString = "",
		rules, i;
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./ucs_viz_ext_gauge-src/resources/templates"
				}]
			}
		}]
	});
