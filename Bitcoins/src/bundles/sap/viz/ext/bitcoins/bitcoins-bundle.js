define("bitcoins-bundle", ["sap_viz_ext_bitcoins-src/js/flow", "css!sap_viz_ext_bitcoins-src/style/default.css"], function(flowDefinition,
	cssStyleDeclaration) {
	var cssString = "",
		rules, i;
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_bitcoins-src/resources/templates"
				}]
			}
		}]
	});
