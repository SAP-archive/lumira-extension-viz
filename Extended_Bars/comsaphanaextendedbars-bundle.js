        ...
        */
        ...
        var areabars = vis.selectAll(".areabars")
            ...
            .attr("width", function (d) {
                return x(+d.Depth[1]-d.Depth[0]);
            })
            .attr("height", function(d){
                return y(0) - y(+d.Hg[0]);
            })
            .style("fill", function(d) {
                return color(d.Needles[1]);
            })
            .style("stroke", "black")
    ...
    (function() {/*__FOLD__*/
        ...
        var flowRegisterFunc = function(){
            ...
            var element  = sap.viz.extapi.Flow.createElement({
                id : 'comsaphanaextendedbarsmodule',
                name : 'Extendedbars Module',
            });
            element.implement('sap.viz.elements.common.BaseGraphic', moduleFunc);
            /*Feeds Definition*/
            //ds1: Needle, needletype
            var ds1 = {
                "id": "comsaphanaextendedbarsmodule.DS1",
                "name": "Needles",
                "type": "Dimension",
                "min": 1,
                "max": 2,
            ...
            _util.mapping.dses.push("Needles");
            //ms1: startdepth, enddepth
            var ms1 = {
                "id": "comsaphanaextendedbarsmodule.MS1",
                "name": "Depth",
                "type": "Measure",
                "min": 1,
                "max": Infinity,
            ...
            _util.mapping.mses.push("Depth");
            //ms2: Hg ng/g(dm)
            var ms2 = {
                "id": "comsaphanaextendedbarsmodule.MS2",
                "name": "Hg",
                "type": "Measure",
                "min": 1,
                "max": Infinity,
            ...
            _util.mapping.mses.push("Hg");
            element.addFeed(ds1);
            element.addFeed(ms1);
            element.addFeed(ms2);
            flow.addElement({
                'element':element,
                'propertyCategory' : 'comsaphanaextendedbars'
            });
            sap.viz.extapi.Flow.registerFlow(flow);
        };
        flowRegisterFunc.id = 'comsaphanaextendedbars';
