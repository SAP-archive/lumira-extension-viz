define("quadrant-bundle", ["sap_viz_ext_quadrant-src/js/flow", "css!sap_viz_ext_quadrant-src/style/default.css"], function(flowDefinition,
	cssStyleDeclaration) {
	var cssString = "",
		rules, i;
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./sap_viz_ext_quadrant-src/resources/templates"
				}]
			}
		}]
	});
